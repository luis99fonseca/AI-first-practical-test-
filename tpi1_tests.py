...
print("t1: ", t1.total_nodes, t1.non_terminal_nodes, t1.terminal_nodes)
t1.show()
#
...
print('t2 length=',t2.solution_length,', nodes=',t2.total_nodes,', cost=',t2.solution_cost,'\n')
#
p3 = SearchProblem(cidades_portugal,'Braga','Evora')
t3 = MyTree(p3,'astar')
print(t3.search2())
print('t3 length=',t3.solution_length,', nodes=',t3.total_nodes,', cost=',t3.solution_cost,'\n')
...
print("t4: ", t4.total_nodes, t4.non_terminal_nodes, t4.terminal_nodes)

t5 = MyTree(p45,'astar',100)
print(t5.search2())
print('t5 total=',t5.total_nodes,', non terminal=',t5.non_terminal_nodes,', terminal=',t5.terminal_nodes)
#
p67 = SearchProblem(cidades_portugal,'Guimaraes','Lisboa')
t6 = MyTree(p67,'astar')
print(t6.search2())
print('t6 total=',t6.total_nodes,', non terminal=',t6.non_terminal_nodes,', terminal=',t6.terminal_nodes)
t7 = MyTree(p67,'astar',65)
print(t7.search2())
print('t7 total=',t7.total_nodes,', non terminal=',t7.non_terminal_nodes,', terminal=',t7.terminal_nodes)

t7a = MyTree(p67,'astar',40)
print(t7a.search2())
print('t7a total=',t7a.total_nodes,', non terminal=',t7a.non_terminal_nodes,', terminal=',t7a.terminal_nodes)